...
public class ActionsService
{
    ...
    private static readonly List<ActionItem> _builtInActions = new()
    {
        ...
        new ActionItem { Id = "enhance_prompt", Name = "Enhance Prompt",  Icon = "✨",  Shortcut = "P", Description = "Rewrite text into a stronger AI-ready prompt",   IsBuiltIn = true, Prompt = "You are an expert prompt engineer. Transform the following input into a high-quality AI prompt that is clear, specific, and actionable. Preserve the original intent and key constraints. Improve structure using: objective, context, constraints, desired output format, and quality criteria where relevant. Do not add unrelated requirements. Return only the enhanced prompt:\n\n{text}" },
